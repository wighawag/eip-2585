...
module.exports = async ({getNamedAccounts, deployments}) => {
    ...
    let contract = await await deployments.get('EIP1776ForwarderWrapper');
    if (!contract) {
        const EIP712Forwarder = await await deployments.get('EIP712Forwarder');
        ...
        contract = await await deployments.get('EIP1776ForwarderWrapper');
